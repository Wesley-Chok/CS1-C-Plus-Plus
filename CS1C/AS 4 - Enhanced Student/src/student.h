...
public:
	...
	student(string nameStudent, string idStudent, string numPhone,
			int ageStudent, int genStudent, string classStudent, double gpaStudent); // overloaded constructor
	 ...
	 *	through main through array of objects. The array object studentArray[3]
	...
	*	studentArray[3] is used to call this function.
	*	_________________________________________________________________________
	*
	* ***********************************************************************/
